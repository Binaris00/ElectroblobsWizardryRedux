...
public final class EBWorldGen {
    ...
    public static final ResourceKey<Structure> SHRINE = ResourceKey.create(Registries.STRUCTURE, WizardryMainMod.location("shrine")); // todo shrine
    public static final ResourceKey<Structure> LIBRARY_RUINS = ResourceKey.create(Registries.STRUCTURE, WizardryMainMod.location("library_ruins")); // todo library ruins
