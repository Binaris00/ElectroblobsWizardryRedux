...
//        if (type == DamageType.BLAST) this.setExplosion();
    ...
    public static String getIndirectDamageNameForType(DamageType type) {
        return WizardrySettings.damageTypePerElement ? type.msgId().toLowerCase() + "_" + INDIRECT_MAGIC_DAMAGE : INDIRECT_MAGIC_DAMAGE;
    }

    public static String getDirectDamageNameForType(DamageType type) {
        return WizardrySettings.damageTypePerElement ? type.msgId().toLowerCase() + "_" + DIRECT_MAGIC_DAMAGE : DIRECT_MAGIC_DAMAGE;
    }
}
