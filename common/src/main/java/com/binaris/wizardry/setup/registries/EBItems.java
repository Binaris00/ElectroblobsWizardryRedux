...
public final class EBItems {
    ...
    public static final DeferredObject<Item> CHARM_EXPERIENCE_TOME = charmArtifact("charm_experience_tome", Rarity.EPIC, changeModifiers(SpellModifiers.PROGRESSION, 0.5F, SpellModifiers.Operation.MULTIPLY_TOTAL));
    public static final DeferredObject<Item> CHARM_FEEDING = charmArtifact("charm_feeding", Rarity.UNCOMMON, new FeedingCharmEffect());
    public static final DeferredObject<Item> CHARM_FLIGHT = charmArtifact("charm_flight", Rarity.RARE, changeModifiersIfCasting(() -> Spells.FLIGHT, SpellModifiers.POTENCY, 0.5f, SpellModifiers.Operation.MULTIPLY_TOTAL));
    ...
    public static final DeferredObject<Item> CHARM_MINION_HEALTH = charmArtifact("charm_minion_health", Rarity.UNCOMMON, changeModifiersIfCastingType(SpellTypes.MINION, SpellModifiers.HEALTH_MODIFIER, 0.5f, SpellModifiers.Operation.MULTIPLY_TOTAL));
    ...
    public static final DeferredObject<Item> RING_BLOCKWRANGLER = ringArtifact("ring_blockwrangler", Rarity.RARE, changeModifiersIfCasting(() -> Spells.GREATER_TELEKINESIS, SpellModifiers.POTENCY, 1.0f, SpellModifiers.Operation.MULTIPLY_TOTAL));
    ...
    public static final DeferredObject<Item> RING_EARTH_BIOME = ringArtifact("ring_earth_biome", Rarity.UNCOMMON, changeModifiersByBiomeElement(Elements.EARTH, Services.PLATFORM::inEarthBiomes, SpellModifiers.POTENCY, 0.3f, SpellModifiers.Operation.MULTIPLY_TOTAL));
    ...
    public static final DeferredObject<Item> RING_FIRE_BIOME = ringArtifact("ring_fire_biome", Rarity.UNCOMMON,changeModifiersByBiomeElement(Elements.FIRE, Services.PLATFORM::intHotBiomes, SpellModifiers.POTENCY, 0.3f, SpellModifiers.Operation.MULTIPLY_TOTAL));
    ...
    public static final DeferredObject<Item> RING_ICE_BIOME = ringArtifact("ring_ice_biome", Rarity.UNCOMMON, changeModifiersByBiomeElement(Elements.ICE, Services.PLATFORM::inIceBiomes, SpellModifiers.POTENCY, 0.3f, SpellModifiers.Operation.MULTIPLY_TOTAL));
