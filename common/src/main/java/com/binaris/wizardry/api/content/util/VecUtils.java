...
/// Utility methods for [Vec3] operations not covered by vanilla Minecraft.
public final class VecUtils {
    ...
    /// Returns a copy of the given vector with one axis component replaced by a new value. Since [Vec3] is immutable,
    ...
    /// @return a new [Vec3] with the specified component replaced
    ...
    /// Equivalent to the block's center ([Vec3#atCenterOf]) offset by half a block
    /// in the direction of the face.
    ///
    /// @param pos  the block position
    /// @param face the face of the block
    /// @return the center point of the specified face as a [Vec3]
    public static Vec3 getFaceCentre(BlockPos pos, Direction face) {
        return Vec3.atCenterOf(pos).add(new Vec3(face.step()).scale(0.5));
    }

    /// Returns all 8 corner vertices of the given [AABB], ordered
    ...
    /// @return an array of 8 [Vec3] vertices
