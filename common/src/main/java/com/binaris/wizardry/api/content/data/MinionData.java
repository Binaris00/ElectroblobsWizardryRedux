...
/// are designated as minions. Instead, you can use [`MinionSpell`][MinionSpell]
...
public interface MinionData {
    ...
    ///
    /// _Note:_ This method is intended for internal use only and should not be called directly or overridden.
    ///
