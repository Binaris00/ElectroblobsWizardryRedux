...
public final class BlockUtil {
    ...
    ///
    ///  - If the block break event is canceled (called on each loader implementation), the block cannot be broken.
    ...
    /// Returns a list of BlockPos in a sphere around a center position.
    ///
    /// @param centre The center position
    /// @param radius The radius of the sphere
    /// @return A list of BlockPos in a sphere around the center position
    ...
    /// A `SurfaceCriteria` object is used to define a 'surface', a boundary between two blocks which differ in
    ...
    ///
    /// _In the context of this class, 'outside' refers to the side of the surface that is in the supplied direction,
    /// and 'inside' refers to the side which is in the opposite direction. For example, if the direction is `UP`,
    /// the inside of the surface is defined as below it, and the outside is defined as above it._
    @FunctionalInterface
    public interface SurfaceCriteria {
        ...
        /// Returns a `SurfaceCriteria` based on the given condition, where the inside of the surface satisfies
        ...
        /// @return True if the side `side` of the block at `pos` in `world` is a valid surface
