...
/// Event fired when a player attempts to place an item in a container (Inside the slot class's `mayPlace` method)
/// Can be canceled to prevent the item from being placed.
