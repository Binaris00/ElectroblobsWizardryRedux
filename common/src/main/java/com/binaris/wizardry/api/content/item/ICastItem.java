...
public interface ICastItem {
    ...
    /// Normally you would call the events [SpellCastEvent.Pre] and [SpellCastEvent.Tick] in order to know
    ...
    /// you could use [net.minecraft.world.item.Item#onUseTick(Level, LivingEntity, ItemStack, int)]
    ///
    /// @param stack The ItemStack to cast the spell from
    /// @param spell The spell to cast
    /// @param ctx The context of the cast
