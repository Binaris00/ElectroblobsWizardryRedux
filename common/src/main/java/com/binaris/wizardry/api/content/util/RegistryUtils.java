...
public final class RegistryUtils {
    ...
    /// @param element The element of the wand. If null, defaults to [Elements#MAGIC].
    ...
    /// arcane tome with the given tier stored in its NBT. [#createArcaneTome(SpellTier)]
    ///
    /// @param tier The tier of the arcane tome.
    /// @return The arcane tome ItemStack.
    ...
    /// @return The spell from the ItemStack, or [Spells#NONE] if the stack has no tag or the spell is not found.
    ...
    /// @return The spell from the CompoundTag, or [Spells#NONE] if the tag is null or the spell is not found.
