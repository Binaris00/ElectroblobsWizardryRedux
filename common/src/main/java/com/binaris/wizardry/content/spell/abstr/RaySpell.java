...
///
/// Check [`FrostRay`][FrostRay] and [`FlameRay`][FlameRay] for examples of ray spells.
///
...
public abstract class RaySpell extends Spell {
    ...
    /// actual effects of hitting an entity or block to the [#onEntityHit] and [#onBlockHit] methods.
    ///
    /// @param ctx       The cast context of the spell.
    /// @param origin    The starting point of the ray.
    /// @param direction The normalized direction vector of the ray.
    ...
    /// spaced according to [#particleSpacing] and have a random jitter based on [#particleJitter]. The
    /// velocity of the particles is determined by [#particleVelocity].
    ///
    /// @param ctx       The cast context of the spell.
    /// @param origin    The starting point of the ray.
    /// @param direction The normalized direction vector of the ray.
