...
/// a block surface (or at maximum range if no block is hit and [#requiresFloor] is false). When cast by an entity,
...
///
/// You must override the [#properties()] to return an actual instance of [SpellProperties]
