...
import com.electroblob.wizardry.client.BlendingHumanoidModel;
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public @Nullable HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                ...
                switch (equipmentSlot) {
                    case HEAD -> { chosen.head.visible = true; chosen.hat.visible = true; }
                    case CHEST -> { chosen.body.visible = true; chosen.rightArm.visible = true; chosen.leftArm.visible = true; }
                    case LEGS, FEET -> { chosen.rightLeg.visible = true; chosen.leftLeg.visible = true; }
                }
