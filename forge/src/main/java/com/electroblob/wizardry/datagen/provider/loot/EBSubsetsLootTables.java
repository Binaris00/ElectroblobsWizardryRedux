        ...
        biConsumer.accept(EBLootTables.SUBSET_EPIC_ARTEFACTS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(EBItems.RING_HAMMER.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.RING_SOULBINDING.get()).setWeight(1))
                                ...
                                .add(LootItem.lootTableItem(EBItems.CHARM_SILK_TOUCH.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.CHARM_STOP_TIME.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.CHARM_BLACK_HOLE.get()).setWeight(1))
                        ));
        ...
        biConsumer.accept(EBLootTables.SUBSET_RARE_ARTEFACTS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(EBItems.RING_DISINTEGRATION.get()).setWeight(1))
                                ...
                                .add(LootItem.lootTableItem(EBItems.RING_MIND_CONTROL.get()).setWeight(1))
                                ...
                                .add(LootItem.lootTableItem(EBItems.RING_DEFENDER.get()).setWeight(1))
                                ...
                                .add(LootItem.lootTableItem(EBItems.AMULET_FIRE_CLOAKING.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.AMULET_POTENTIAL.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.AMULET_ANCHORING.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.AMULET_TRANSIENCE.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.AMULET_AUTO_SHIELD.get()).setWeight(1))
                                ...
                                .add(LootItem.lootTableItem(EBItems.CHARM_ABSEILING.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.CHARM_LIGHT.get()).setWeight(1))
                                .add(LootItem.lootTableItem(EBItems.CHARM_TRANSPORTATION.get()).setWeight(1))
        ...
        biConsumer.accept(EBLootTables.SUBSET_UNCOMMON_ARTEFACTS,
                LootTable.lootTable()
                        .withPool(LootPool.lootPool()
                                ...
                                .add(LootItem.lootTableItem(EBItems.AMULET_BANISHING.get()))
